...
def include_header(the_title):
    with open('/home/knoix/PycharmProjects/Heard_First/webapp/webapp/templates/header.html') as headf:
        head_text = headf.read()
    header = Template(head_text)
    return (header.substitute(title=the_title))

def include_footer(the_links):
    with open('/home/knoix/PycharmProjects/Heard_First/webapp/webapp/templates/footer.html') as footf:
...
def do_form(name, the_inputs, method="POST", text="Submit"):
    ...
    inputs = create_imputs(the_inputs)
